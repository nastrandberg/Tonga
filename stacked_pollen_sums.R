...
#Avai'o'vuna
avai_long <- gather(avai_groups, Group, Percentage, "Successional":"Wetland", factor_key=TRUE)
...
#Finemui
fine_long <- gather(fine_groups, Group, Percentage, "Successional":"Wetland", factor_key=TRUE)
...
loto_long <- gather(loto_groups, Group, Percentage, "Successional":"Wetland", factor_key=TRUE)
...
#Ngofe
ngof_long <- gather(ngof_groups, Group, Percentage, "Successional":"Wetland", factor_key=TRUE)
